...
open class SwiftyOnboardOverlay: UIView {
    ...
    open var pageControl: UIPageControl = {
        ...
        pageControl.currentPageIndicatorTintColor = #colorLiteral(red: 0.5386385322, green: 0.6859211922, blue: 0, alpha: 1)
        return pageControl
    }()
    ...
    func setUp() {
        ...
        continueButton.bottomAnchor.constraint(equalTo: pageControl.topAnchor, constant: -30).isActive = true
        continueButton.leftAnchor.constraint(equalTo: margin.leftAnchor, constant: 90).isActive = true
        continueButton.rightAnchor.constraint(equalTo: margin.rightAnchor, constant: -90).isActive = true
